...
<script lang="ts" setup>
  ...
  import {
    formList, columns, tableHeaderBtns, createBaseFormDrawerList,
    carSearchFormData,
  } from "./const";
  ...
  const searchFormData = ref(carSearchFormData);
  const onSearch = async (query: any) => {
    console.log("onSearch", query);
    tableQueryParams.value = query; // tableQueryParams 参数改变时会自动发起查询表单
  }
